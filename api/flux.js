...
// Route for handling Flux image generation requests
router.get('/flux-image', async (req, res) => {
    ...
    try {
        ...
        while (data) {
            // Polling the Flux API for task completion
            ...
            switch (response.status) {
                ...
                case "completed":
                    ...
                    res.type('json').send(JSON.stringify({
                        status: "success",
                        message: "Image generated successfully by Flux model.",
                        data: response
                    }, null, 2))
                    break
                case "error":
...
const serviceMetadata = {
    ...
    author: "Jerome",
    description: "A route to interact with the Flux image generation model by providing a prompt.",
    category: "AI Image Generation",
    link: ["/api/flux-image?prompt=dog"]
}
