...
import { router as chipkura } from './api/chipkura.js';
app.use('/service/api', chipkura);
...
import { router as imgbbRouter } from './api/imgbb.js';
app.use('/service/api', imgbbRouter);
